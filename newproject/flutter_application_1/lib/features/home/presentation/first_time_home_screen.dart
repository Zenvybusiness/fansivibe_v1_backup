...
/// First-time Home screen for users who have completed style analysis/preferences.
///
/// Implements the exact visual architecture from Homes.pdf:
/// - FANSIVIBE Branding & greeting
/// - Today's Look curated recommendation card
...
/// - Style Journey & AI Insight progress card
...
class _FirstTimeHomeScreenState extends State<FirstTimeHomeScreen>
  ...
  String? get _selectedVibe => LocalStorage.vibe;
  ...
  Widget build(BuildContext context) {
    final curatedLook = getCuratedLookForVibe(_selectedVibe);
