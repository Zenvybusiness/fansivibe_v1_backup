              ...
              children: [
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    filled: true,
                    fillColor: FansivibeColors.surfaceContainerLow.withValues(alpha: 0.5),
        ...
        return Opacity(
          ...
          child: Column(
            children: [
              Row(
                children: [
                  Expanded(child: Divider(color: FansivibeColors.outlineVariant.withValues(alpha: 0.3))),
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: FansivibeSpacing.md),
                    child: Text(
                      'or continue with',
                ...
                children: [
                  Expanded(
                    child: FilledButton.icon(
                      ...
                      label: Text('Google', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500)),
                  ...
                  Expanded(
                    child: FilledButton.icon(
                      ...
                      label: Text('Apple', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500)),
                      style: FilledButton.styleFrom(
                        backgroundColor: FansivibeColors.surfaceContainerHigh,
                        foregroundColor: FansivibeColors.onSurface,
                        shape: RoundedRectangleBorder(
